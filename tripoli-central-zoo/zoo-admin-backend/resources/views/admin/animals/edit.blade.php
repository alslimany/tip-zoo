        ...
        <form action="{{ route('admin.animals.update', $animal) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.000001" class="form-control @error('location_x') is-invalid @enderror" 
                                   id="location_x" name="location_x" value="{{ old('location_x', $animal->location_x) }}">
                            @error('location_x')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.000001" class="form-control @error('location_y') is-invalid @enderror" 
                                   id="location_y" name="location_y" value="{{ old('location_y', $animal->location_y) }}">
                            @error('location_y')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Click on the map to update the animal's location</small>
                </div>
